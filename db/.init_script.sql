...
CREATE TABLE IF NOT EXISTS public."MATRICULAS" ("DNI" text NOT NULL, "DEPORTE" TEXT NOT NULL, "HORARIO" TEXT NOT NULL, PRIMARY KEY ("DNI", "DEPORTE"), FOREIGN KEY ("DNI") REFERENCES public."CLIENTES"("DNI"), FOREIGN KEY ("DEPORTE") REFERENCES public."DEPORTES"("NOMBRE"), FOREIGN KEY ("DEPORTE") REFERENCES public."DEPORTES"("NOMBRE"));
